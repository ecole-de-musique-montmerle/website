...
<svelte:head>
	<title>Politique de confidentialité | École de Musique 3 Rivières</title>
	<meta
		name="description"
		content="Politique de confidentialité de l'École de Musique 3 Rivières conformément au Règlement Général sur la Protection des Données (RGPD) et à la loi Informatique et Libertés."
	/>
...
>
	<div class="container">
		<article class="prose">
			...
			<section class="prose__section" aria-labelledby="finalites">
				<h2 id="finalites">Finalités</h2>
				<p>Les données techniques d'accès sont utilisées exclusivement pour&nbsp;:</p>
				<ul>
					<li>assurer la sécurité et l'intégrité du site,</li>
					<li>diagnostiquer et résoudre les incidents techniques,</li>
					<li>respecter d'éventuelles obligations légales de conservation.</li>
				</ul>
			</section>
